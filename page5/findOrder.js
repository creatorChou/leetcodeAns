...
var makeGraph = (numCourses, prerequisites) => {
  let arr = new Array(numCourses).fill(true);
  for (let i = 0; i < prerequisites.length; i ++) {
    let rule = prerequisites[i][1];
